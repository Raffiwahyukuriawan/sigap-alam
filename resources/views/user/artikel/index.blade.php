...
<section class="hero-section">
    <div class="container text-center hero-content">
        ...
        <h1 class="hero-title">Artikel Edukasi Bencana Alam</h1>
        <p class="hero-subtitle" style="max-width: 700px; margin: 0 auto;">
            Baca artikel edukatif seputar bencana alam, mitigasi, dan kesiapsiagaan.
        </p>
    </div>
</section>
...
<section class="py-5 bg-gradient-card" id="artikel">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <h2 class="display-5 fw-bold mb-3">Artikel Tentang Semua Jenis Bencana</h2>
